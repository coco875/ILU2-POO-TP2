	...
	public void acheterProduit(String nomAcheteur) {
		...
		if (!nomAcheteurConnu) {
			...
			if (nbAchete==0) {
				...
				System.out.println(nomAcheteur+" veut acheter "+nbProduit+" "+produit+", malheureusement "+vendeur+" n’en a plus que "+nbAchete+". "+nomAcheteur+" achète tout le stock de "+vendeur+".");
			} else {
